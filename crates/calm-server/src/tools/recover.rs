...
impl CalmServer {
    ...
    // format_files already write to (tools/edit.rs) -- none of these
    // change what a normal edit does, they only expose what the journal
    // already recorded.
    // -------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// WS-1 durable edit-transaction / maintenance-outbox admin tools (plan §4.7)
// ---------------------------------------------------------------------------
